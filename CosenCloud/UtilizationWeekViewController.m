//
//  UtilizationWeekViewController.m
//  CosenCloud
//
...
@interface UtilizationWeekViewController ()
{
...
@implementation UtilizationWeekViewController
...
- (void)viewDidLoad {
    ...
    self.dataX=@[@"8/24",@"8/31",@"9/7",@"9/14"];
    
    
    
    NSArray *arr1 =@[@"9",@"11",@"14",@"18"];
    NSArray *arr2 =@[@"11",@"19",@"3",@"17"];
    NSArray *arr3 =@[@"16",@"15",@"14",@"18"];
    NSArray *arr4 =@[@"12",@"29",@"16",@"18"];
